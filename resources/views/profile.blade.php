...
@section('contents')
    ...
    @push('scripts')
        <script>
            const flyoutMenu = document.getElementById('productFlyout');
            const toggleButton = document.getElementById('toggleFlyoutButton');

            toggleButton.addEventListener('click', () => {
                if (flyoutMenu.classList.contains('hidden')) {
                    flyoutMenu.classList.remove('hidden');
                    flyoutMenu.classList.add('entering');
                    setTimeout(() => {
                        flyoutMenu.classList.remove('entering');
                        flyoutMenu.classList.add('entered');
                    }, 0);
                } else {
                    flyoutMenu.classList.remove('entered');
                    flyoutMenu.classList.add('leaving');
                    setTimeout(() => {
                        flyoutMenu.classList.remove('leaving');
                        flyoutMenu.classList.add('hidden');
                    }, 150); // Use the leaving transition duration
                }
            });
        </script>
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                const productButton = document.querySelector(".mobile-product-button");
                const productSubMenu = document.querySelector("#disclosure-1");
