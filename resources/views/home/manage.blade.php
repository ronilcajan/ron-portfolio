    ...
    <div class="mx-auto max-w-2xl sm:py-48 md:py-38 lg:py-32 mt-10" id="home">
        <div class="text-center">
            <div class="text-center mb-4">
                <img class="mx-auto rounded-full" src="{{ asset('img/profile.jpg') }}" width="200" alt="photo">
            </div>
            ...
            <div class="flex items-center justify-center gap-x-6 mt-2">
                <a href=""><img class="w-5" src="{{ asset('img/github.png') }}" alt=""></a>
                <a href=""><img class="w-5" src="{{ asset('img/linkedin.png') }}" alt=""></a>
                <a href=""><img class="w-5" src="{{ asset('img/twitter.png') }}" alt=""></a>
                <a href=""><img class="w-5" src="{{ asset('img/skype.png') }}" alt=""></a>
                <a href=""><img class="w-5" src="{{ asset('img/gmail.png') }}" alt=""></a>
