...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-end mb-3">
            ...
            <x-primary-button type="button" x-on:click="$dispatch('open-modal', 'createModal')">
                Create Experience
            </x-primary-button>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            ...
            <nav class="flex items-center justify-between pt-4 p-3" aria-label="Table navigation">
        ...
        <x-modal name="createModal" :show="false">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button"
                    class="close absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                    x-on:click="createModal = false" id="close">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" action="#">
                        ...
                        <div class="flex justify-end">
                            ...
                            <x-secondary-button type="button" class="mr-3 close" x-on:click="show = true">
                                Close
                            </x-secondary-button>
